    ...
    return (
        <section className="my-14">
            <div className="container mx-auto flex flex-col items-center pb-6 mb-4 md:p-10 md:px-12">
                <h1 className="text-4xl font-semibold leading-none text-center">Buyer's & Seller's Review</h1>
            </div>
            <div className="container mx-auto grid grid-cols-1 gap-8 lg:gap-20 md:px-10 md:pb-10 lg:grid-cols-2">
                <div className="flex flex-col items-center mx-12 lg:mx-0">
                    <div className="relative text-center">
                        ...
                        <p className="px-6 py-1 text-lg italic">It's a great platform to sell the books i've already read. I read buy a lot of books so i need to clean up after i finished.This platform is very handy to do so.</p>
                ...
                <div className="flex flex-col items-center max-w-lg mx-12 lg:mx-0">
                    <div className="relative text-center">
                        ...
                        <p className="px-6 py-1 text-lg italic">I think it's a great platform to buy books at a very cheaper price. I can easily buy the books i want. Besides, this site provide ample of discounts for students. So it's really very cheap you can't even imagine!!!</p>
