...
const Category = () => {
    ...
    const { category_name, image, bookName, location, originalPrice
        , resalePrice, used, posted, seller } = categoryItems;
    return (
        <div className='min-h-screen grid grid-cols-1 gap-6 my-6'>
            {
                categoryItems.map(categoryItem => <article class="flex bg-white transition hover:shadow-xl">
